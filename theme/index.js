...
Generator.prototype.installTheme = function() {
  ...
  omeka.getContentDir().on('done', function() {
    //todo test this
    omeka.installTheme(me, me.userInput, done);
  });
...
Generator.prototype.setupTheme = function() {
  omeka.setupTheme(this, this.userInput, this.async());
};

// Activate theme
Generator.prototype.activateTheme = function() {
  omeka.activateTheme(this.userInput.themeDir, this.async());
};
